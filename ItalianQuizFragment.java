 ...
 */
public class ItalianQuizFragment extends Fragment {


    public ItalianQuizFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rootLL.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.category_italian));
        ...
        ChecklistAdapter phrasesChecklistAdapter = new ChecklistAdapter(getContext(), phrases, ITALIAN);
        phrasesListView.setAdapter(phrasesChecklistAdapter);

        ListView numbersListView = rootView.findViewById(R.id.checklist_numbers);
        ChecklistAdapter numbersChecklistAdapter = new ChecklistAdapter(getContext(), numbers, ITALIAN);
